...
public class base {
    ...
    public static String browserStack_userName ="mydemo_WcShxT"; //"demo_i3wOhm";  // mydemo_WcShxT
    public static String browserStack_accesskey = "hpWMRG4oWSpvqBYWGfTX";//"XVTTzqMqLhvWBkDZQvNq";  // hpWMRG4oWSpvqBYWGfTX
